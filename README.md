- After each workshop day, a script will be uploaded with all code that has been ran during the workshop, with the file name like "Script_WS1.r" (and WS2, WS3, WS4).
